...
from model.utils.data_padding import padd_arrays, unpadd_arrays
    ...
    def fit(self, X, Y, verbosity=True):
        ...
        for epoch in range(self.EPOCH):
            ...
            for step in range(self.N_STEPS):
                ...
                print("Output shape before view:", b_x.shape)
                # output = self(b_x).view(-1, self.MAX_STEPS)  # rnn output
                output = output.view(self.batch_size, self.MAX_STEPS, -1)
